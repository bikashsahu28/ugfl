...
const LoanApplicationForm = () => {
  ...
  return (
    ...
    //     <p className="text-gray-600 mt-2">Fill out the form below to apply for a gold loan</p>
    //   </div>
    ...
    //           Gold Purity <span className="text-red-500">*</span>
    //         </label>
    //         <select
    //           id="goldType"
    //           name="goldType"
    ...
    //           I agree to the <a href="#" className="text-yellow-600 hover:underline">terms and conditions</a> <span className="text-red-500">*</span>
    //         </label>
